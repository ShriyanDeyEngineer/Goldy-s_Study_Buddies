    ...
    <div className="mx-auto max-w-6xl px-4 py-14">
        <div className="mx-auto max-w-2xl">
            ...
            <h2 className="font-display text-2xl text-ink text-left">1. Eligibility and Account Registration</h2>
                <p className="mt-4 text-ink-muted text-left">
                    <span className="font-bold">Google Sign-In Only.</span> The Service is accessed exclusively through "Sign in with Google" using your University of Minnesota &#40;`@umn.edu`&#41; Google Workspace account. There is no separate username/password system, and we do not accept sign-ups from non-UMN Google accounts.
                </p>
                <p className="mt-4 text-ink-muted text-left">
                ...
                <p className="mt-4 text-ink-muted text-left">
                    <span className="font-bold">Age.</span> The Service authenticates users through UMN's SSO system, which does not verify age to us. If you are under the age of 13, you may not use the Service &#40;see our Privacy Policy, Section 7&#41;. If you are between 13 and 18, please review the Privacy Policy's disclosures about profile visibility and chat features with a parent or guardian before using the Service.
                </p>
            ...
            <h2 className="font-display text-2xl text-ink text-left">3. Acceptable Use</h2>
                ...
                <p className="mt-4 text-ink-muted text-left">
                    - Use the Service for any unlawful purpose or in violation of any applicable UMN student conduct policy.
                </p>
            ...
            <h2 className="font-display text-2xl text-ink text-left">4. User Content</h2>
                ...
                <p className="mt-4 text-ink-muted text-left">
                    <span className="font-bold">Responsibility.</span> You are solely responsible for the content you post. We do not pre-screen content and are not responsible for the accuracy, legality, or appropriateness of user-submitted content.
                </p>
                <p className="mt-4 text-ink-muted text-left">
            ...
            <h2 className="font-display text-2xl text-ink text-left">10. Account Termination</h2>
                <p className="mt-4 text-ink-muted text-left">
                    <span className="font-bold">By You.</span> You may delete your account at any time. Deletion is permanent and irreversible, and your data will be removed as described in our Privacy Policy, Section 6.
                </p>
                <p className="mt-4 text-ink-muted text-left">
                ...
                <p className="mt-4 text-ink-muted text-left">
                    <span className="font-bold">Inactivity.</span> Accounts inactive for more than 24 consecutive months are automatically purged, as described in our Privacy Policy, Section 6.
                </p>
            ...
            <h2 className="font-display text-2xl text-ink text-left">12. Governing Law</h2>
                <p className="mt-4 text-ink-muted text-left">
                    These Terms are governed by the laws of the State of Minnesota, without regard to its conflict-of-law principles, without prejudice to any consumer protection rights you may have under the laws of your place of residence.
                </p>

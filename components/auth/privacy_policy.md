...
To ensure a secure environment restricted to verified college communities, you must log in using your official university credentials (e.g., via your institution's Single Sign-On system). Through this authentication process, we collect:
*   **Official Name** (First and Last name)
*   **Institutional Email Address** (e.g., your `.edu` email)
*   **University Affiliation** (The specific college or university you attend)
...
*   **Meetup & Schedule Data:** Calendar availability, study preferences, and proposed meetup locations or times.
...
*   Authenticate your identity and restrict platform access exclusively to active university students.
...
*   Enforce our Terms of Service and protect the safety of our student community.
...
The Service is strictly intended for individuals who are **18 years of age or older** and currently enrolled in a higher education institution. We do not knowingly collect or solicit personal information from anyone under the age of 18. If we learn that we have inadvertently collected personal data from a minor, we will delete that information immediately from our Supabase database.

---

## 6. Your Rights and Controls

Depending on your jurisdiction and university policies, you may have specific data control rights:
